...
const callsignPrefixMap = [
  ...
  ['ON', 'be'], ['OE', 'at'], ['HB', 'ch'], ['SM', 'se'], ['LA', 'no'], ['OJ0', 'fi'], ['OH', 'fi'], ['OY', 'fo'], ['OZ', 'dk'],
  ['SP', 'pl'], ['SN', 'pl'], ['SO', 'pl'], ['SQ', 'pl'], ['SR', 'pl'], ['HF', 'pl'], ['3Z', 'pl'], ['OK', 'cz'], ['OL', 'cz'], ['OM', 'sk'], ['S5', 'si'], ['9A', 'hr'], ['YO', 'ro'], ['YU', 'rs'], ['YT', 'rs'], ['YZ', 'rs'], ['LZ', 'bg'], ['SV', 'gr'], ['TA', 'tr'],
